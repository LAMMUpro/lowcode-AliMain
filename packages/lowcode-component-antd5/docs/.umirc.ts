...
const productPath = `/@lammu/lowcode-component@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('@lammu/lowcode-component', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    '@lammu/lowcode-component': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
